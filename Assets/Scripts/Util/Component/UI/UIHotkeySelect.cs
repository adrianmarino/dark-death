...
{ 
     public class UIHotkeySelect : MonoBehaviour
     {
         ...
         private void Update()
         {
             ...
             {
                 HandleHotkeySelect(UnityEngine.Input.GetKey(KeyCode.LeftShift) || UnityEngine.Input.GetKey(KeyCode.RightShift), true, false); // Navigate backward when holding shift, else navigate forward.
             }
